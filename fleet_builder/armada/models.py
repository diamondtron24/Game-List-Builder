...
class BaseShip(models.Model):
    ...
    fleet_support_1 = models.BooleanField(default=False)
    fleet_support_2 = models.BooleanField(default=False)
    ...
    ordnance_1 = models.BooleanField(default=False)
    ordnance_2 = models.BooleanField(default=False)
